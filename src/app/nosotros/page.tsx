  ...
  return (
    <main className="min-h-screen bg-white text-[#111111]">
      ...
      <section className="mx-auto w-full max-w-7xl px-5 py-10 md:py-16">
        <div className="text-[1.04rem] leading-8 text-[#050505] sm:text-[1.2rem] sm:leading-9">
          <p className="flex flex-wrap items-end gap-x-2 gap-y-1">
            <Image
              ...
              height={1183}
              priority
              className="mb-[-0.18rem] h-14 w-auto sm:h-20"
            />
            <span>
          ...
          <div className="mt-8 space-y-7 text-left sm:text-justify">
            <p>
      ...
      <section className="border-y border-[#e7e7e7] bg-[#f7f7f7]">
        <div className="mx-auto w-full max-w-6xl px-5 py-10 md:py-16">
          <div className="grid gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-start">
            ...
            <aside className="space-y-6 text-base leading-8 text-[#333333] sm:text-lg">
              <div className="rounded-[8px] border border-[#dedede] bg-white p-5 shadow-sm sm:p-6">
                <p>
