    ...
    >
      <div className='mx-auto max-w-[610px]'>
        <a
          ...
          className='block aspect-[3/1] overflow-hidden rounded-[18px] shadow-[0_18px_45px_rgba(0,0,0,0.14)] transition-[box-shadow,transform] duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_24px_58px_rgba(0,0,0,0.18)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#61c8ab]/35 motion-reduce:transition-none motion-reduce:hover:translate-y-0'
        >
          <Image
